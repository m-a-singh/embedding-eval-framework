...
def build_request(json_data: dict[str, Any]) -> str:
    parts = [
        normalize_scalar_field(json_data.get("name")),
        normalize_unlabeled_list_field(json_data.get("sponsors")),
        normalize_scalar_field(json_data.get("description") or json_data.get("name")),
        normalize_unlabeled_list_field(json_data.get("tagCategories")),
        normalize_unlabeled_list_field(json_data.get("tagTopics")),
    ]
